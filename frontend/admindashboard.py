...
class AdminDashboard:
    def __init__(self, main):
        ...
        titlelabel = Label(self.main, text="Welcome {}".format(
            Global.currentAdmin[1]), bg="#4CD964", font=('Times New Roman', 25, 'bold'))
        ...
        # image
        image = Image.open(
            "C:\\Users\\adity\Pictures\Taxi-cab 2nd\image\Order ride-bro.png")
        ...
        def assigndriver():
            ...
            assgnlabel = Label(topframe, text="ASSIGN DRIVER FOR CUSTOMERS", font=(
            ...
            def getbookingtabledata(a):
                ...
                daddress_txt1.insert(
                    0, assigndrivertable.item(itemselect11)['values'][4])
                date_txt.insert(0, assigndrivertable.item(
                    itemselect11)['values'][5])
                time_txt.insert(0, assigndrivertable.item(
        ...
        assignbtn = Button(sideframe, text="Assign Driver", command=assigndriver,
        ...
        analyticsframe1 = Frame(
            centerframe, bg='#e2f3f5', width=250, height=200)
        ...
        lbl1 = Label(analyticsframe1, text="Total Customers \n\n {}".format(
            customerresult2), font=sidefont, bg='#e2f3f5')
        lbl1.place(relx=0.5, rely=0.5, anchor=CENTER)

        analyticsframe2 = Frame(
            centerframe, bg='#e2f3f5', width=250, height=200)
        ...
        lbl2 = Label(analyticsframe2, text="Total Booking \n\n {}".format(
            bookingresult2), font=sidefont, bg='#e2f3f5')
        lbl2.place(relx=0.5, rely=0.5, anchor=CENTER)

        analyticsframe3 = Frame(
            centerframe, bg='#e2f3f5', width=250, height=200)
        ...
        lbl3 = Label(analyticsframe3, text="Total Drivers \n\n {}".format(
            driverresult2), font=sidefont, bg='#e2f3f5')
        lbl3.place(relx=0.5, rely=0.5, anchor=CENTER)

        analyticsframe4 = Frame(
            centerframe, bg='#e2f3f5', width=250, height=200)
        ...
        monthresult = monthbookingcount()
        monthresult1 = monthresult[0]
        monthresult2 = monthresult1[0]

        lbl4 = Label(analyticsframe4, text="{} Booking \n\n {}".format(
            month, monthresult2), font=sidefont, bg='#e2f3f5')
        ...
        frame3 = Frame(maintab)

        maintab.add(frame1, text="Requested Booking")
        maintab.add(frame2, text="Active Booking")
        maintab.add(frame3, text="Booking History")
        ...
        activebookingtable = ttk.Treeview(frame2)
        activebookingtable.pack(side=BOTTOM, fill=BOTH,
                                expand=TRUE, pady=(10, 0))
        activebookingtable['columns'] = (
            'bid', 'pickup', 'dropoff', 'date', 'time', 'status')
        activebookingtable.column('#0', width=0, stretch=0)
        activebookingtable.column('bid', width=100, anchor=CENTER)
        activebookingtable.column('pickup', width=50, anchor=CENTER)
        activebookingtable.column('dropoff', width=100, anchor=CENTER)
        activebookingtable.column('date', width=100, anchor=CENTER)
        activebookingtable.column('time', width=100, anchor=CENTER)
        activebookingtable.column('status', width=100, anchor=CENTER)

        activebookingtable.heading('#0', text='', anchor=CENTER)
        activebookingtable.heading('bid', text='Booking ID', anchor=CENTER)
        activebookingtable.heading(
            'pickup', text='Pickup Address', anchor=CENTER)
        activebookingtable.heading(
            'dropoff', text='Dropoff Address', anchor=CENTER)
        activebookingtable.heading('date', text='Date', anchor=CENTER)
        activebookingtable.heading('time', text='Time', anchor=CENTER)
        activebookingtable.heading('status', text='Status', anchor=CENTER)

        def activebooking123():
            activeResult = activebookingtable720()
            for row in activeResult:
                activebookingtable.insert(parent='', index='end', values=(
                    row[0], row[1], row[2], row[3], row[4], row[5]))

        activebooking123()

        historytable = ttk.Treeview(frame3)
