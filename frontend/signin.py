...
class TaxiLogin:
    ...
    def __init__(self, root):
            ...
            if (email_txt.get() == '') or (password11.get() == ''):
                ...
                if user != None:
                    msg1 = messagebox.showinfo(
                        "Taxi Booking System", "Welcome Customer {}".format(user[1]))
                    ...
                    msg2 = messagebox.showinfo(
                        "Taxi Booking System", "Welcome Driver {}".format(duser[1]))
                    ...
                    msg3 = messagebox.showinfo(
                        "Taxi Booking System", "Welcome admin {}".format(auser[1]))
        ...
        signup_txt = Label(
            frame2, text="Sign up here if you don't have account \n for customers only", bg="#4CD964", font=font2)
        signup_txt.place(x=125, y=280)
